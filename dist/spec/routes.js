...
function RegisterRoutes(app) {
    ...
    app.get('/users/:id', function UsersController_getUser(request, response, next) {
        ...
        try {
            ...
            var controller = new UserController_1.UsersController();
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/users', function UsersController_listUsers(request, response, next) {
        var args = {};
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        var validatedArgs = [];
        try {
            validatedArgs = getValidatedArgs(args, request, response);
            var controller = new UserController_1.UsersController();
            var promise = controller.listUsers.apply(controller, validatedArgs);
            promiseHandler(controller, promise, response, undefined, next);
        }
        catch (err) {
            return next(err);
    ...
    app.post('/users', function UsersController_createUser(request, response, next) {
        var args = {
            body: { "in": "body", "name": "body", "required": true, "ref": "UserPostBody" },
        };
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        var validatedArgs = [];
        try {
